# Datasets for the 30 Day Map Challenge
...
- [`england.json`](england.json) extracted from [ukConstituencies.json](https://github.com/gicentre/data/blob/main/uk/ukConstituencies.json)
...
- [`floorPlanA.json`](floorPlanA.json), [`floorPlanL.json`](floorPlanL.json), [`floorPlanLabels.csv`](floorPlanLabels.csv) and [`floorPlanJokes.csv`](floorPlanJokes.csv) generated by author.
- Architects Daughter Font: [Google Fonts](https://fonts.google.com/specimen/Architects+Daughter).
